	...
	<div class="player" v-show="playlist.length">
		<transition name="normal" @enter="enter" @after-enter="afterEnter" @leave="leave" @after-leave="afterLeave">
			<div class="normal-player" v-show="fullScreen">
				...
				<div class="top mt-2">
					<div class="back">
						<i class="iconfont icon-zuojiantou text-priamry" @click="back"></i>
					</div>
					<h2>{{currentSong.songname}}</h2>
					<h3>{{currentSong.singername}}</h3>
				</div>
				<div class="middle">
...
<script>
	...
	import ProgressBar from '@/components/main/play/ProgressBar'
	import ProgressCircle from '@/components/main/play/ProgressCircle'
	import PlayList from '@/components/main/play/PlayList'
